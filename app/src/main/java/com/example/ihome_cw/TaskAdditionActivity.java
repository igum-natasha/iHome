...
//                String Name = etName.getText().toString();
                ...
                SceneTask task = TuyaHomeSdk.getSceneManagerInstance().createDelayTask(
                        2,  // The number of minutes.
                        2  // The number of seconds.
                );
                tasks.add(task);
                TimerRule timerRule = TimerRule.newInstance("Europe/Moscow","1111111","18:17","20220402");
                SceneCondition condition = SceneCondition.createTimerCondition(
    ...
    private void initializeData() {
        TuyaHomeSdk.getSceneManagerInstance().getSceneList(HomeActivity.getHomeId(), new ITuyaResultCallback<List<SceneBean>>() {
            @Override
            public void onSuccess(List<SceneBean> result) {
                scenes = result;
//                Toast.makeText(TaskAdditionActivity.this, scenes.size(), Toast.LENGTH_LONG)
//                        .show();
            }
