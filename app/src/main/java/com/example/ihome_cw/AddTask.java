...
public class AddTask {
    ...
    public SceneCondition createTimeSceneCond(String Name, String date) {
        TimerRule timerRule =
                TimerRule.newInstance(
                        TimeZone.getDefault().getID(), repeatList, time, date);
    ...
    public void addTask(String Name, List<SceneTask> tasks, List<SceneCondition> conditions, Context context, boolean state) {
    ...
    private int getResourceId(String image, Context context) {
        ...
        return resources.getIdentifier(image, "drawable", context.getApplicationContext().getPackageName());
    }
