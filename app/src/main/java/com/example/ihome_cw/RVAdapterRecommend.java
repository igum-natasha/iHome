...
public class RVAdapterRecommend extends RecyclerView.Adapter<RVAdapterRecommend.TaskViewHolder> {
    ...
    @Override
    public void onBindViewHolder(RVAdapterRecommend.TaskViewHolder taskViewHolder, @SuppressLint("RecyclerView") int i) {
        taskViewHolder.taskName.setText(tasks.get(i).getSceneName());
        taskViewHolder.image.setBackgroundResource(tasks.get(i).getImage());
        taskViewHolder.plus.setOnClickListener(new View.OnClickListener() {
            @Override
                        ...
                        .enableScene(
                                ...
                                new IResultCallback() {
                                    ...
                                    public void onSuccess() {
                                        ...
                                        Intent intent = new Intent(taskViewHolder.plus.getContext(), TaskAdditionActivity.class); // ?
