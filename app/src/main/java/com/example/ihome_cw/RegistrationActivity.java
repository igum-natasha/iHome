...
public class RegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnVarificationCode.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    IResultCallback validateCallback = new IResultCallback() {
        ...
        public void onError(String s, String s1) {
            ...
            Toast.makeText(RegistrationActivity.this, "Failed to sent verification code!", Toast.LENGTH_LONG).show();
        }
