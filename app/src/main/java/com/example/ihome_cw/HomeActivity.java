        ...
        tuyaActivator = TuyaHomeSdk.getActivatorInstance().newMultiActivator(new ActivatorBuilder()
                ...
                .setListener(new ITuyaSmartActivatorListener() {
                    ...
                    public void onActiveSuccess(DeviceBean deviceBean) {
                        Toast.makeText(HomeActivity.this, "Devices detection successful!", Toast.LENGTH_LONG).show();
                    ...
                    public void onStep(String s, Object o) {
                        switch(s) {
                            case ActivatorEZStepCode
                                    .DEVICE_BIND_SUCCESS:
                                Toast.makeText(HomeActivity.this, "Devices bind successful!", Toast.LENGTH_LONG).show();
                                break;
